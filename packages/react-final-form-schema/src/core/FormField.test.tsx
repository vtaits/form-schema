...
describe('getFieldSchema', () => {
  ...
  test('should return `getFieldSchema` from parent context if defined', () => {
    ...
    expect(engine.getHookArguments('getFieldSchema')[0]()).toBe(parentFieldContext.getFieldSchema);
  });
  ...
  test('should return `getFieldSchema` from form context', () => {
    ...
    expect(engine.getHookArguments('getFieldSchema')[0]()).toBe(rootGetFieldSchema);
  });
});
...
describe('fieldSchema', () => {
  ...
  test('should make schema of the field', () => {
    ...
    expect(engine.getHookArguments('fieldSchema')[0]()).toBe('schema of the field');
...
describe('getChildFieldSchema', () => {
  ...
  test('should return default `getFieldSchema` if it is not redefined in the type of current field', () => {
    ...
    expect(engine.getHookArguments('getChildFieldSchema')[0]()).toBe(getFieldSchema);
  });
  ...
  test('should return redefined `getFieldSchema`', () => {
    ...
    expect(engine.getHookArguments('getChildFieldSchema')[0]()).toBe(childGetFieldSchema);
