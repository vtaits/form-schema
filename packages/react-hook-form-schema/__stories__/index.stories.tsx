...
import { ExcludeFromRender } from "../src/examples/ExcludeFromRender";
...
export const DynamicStory: StoryObj<{
	...
	render: ({ default_values: defaultValues }) => (
...
export const ExcludeFromRenderStory: Story = {
	name: "Exclude from render",
	args: {},
	render: () => <ExcludeFromRender />,
};
